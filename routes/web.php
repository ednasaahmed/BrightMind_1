...
Route::post('/tutmaterias/update/{id}', [TutMateriaController::class, 'update'])->name('tutmaterias.update');
Route::post('/tutmaterias/delete/{id}', [TutMateriaController::class, 'delete'])->name('tutmaterias.delete');
