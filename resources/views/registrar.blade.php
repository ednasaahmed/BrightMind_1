...
<div class="container text-center">
  ...
  <div style="text-align: center;">
    ...
    <div class="form-floating">
      ...
      <label name="nombre" for="floatingNombre">Nombre</label>
    </div>
    <div class="form-floating">
      <input class="form-control reg-campos mb-3" placeholder="APELLIDO PATERNO" id="floatingPaterno">
      <label name="apellido_paterno" for="floatingPaterno">Apellido Paterno</label>
    </div>
    <div class="form-floating">
      <input class="form-control reg-campos mb-3" placeholder="APELLIDO MATERNO" id="floatingMaterno">
      <label name="apellido_materno" for="floatingMaterno">Apellido Materno</label>
    </div>
    ...
    <div>
      <div class="form-floating mb-3" id="fecha">
        ...
        <label name="fecha_nacimiento" for="floatingFecha">Fecha de Nacimiento</label>
      </div>     

      <div class="form-floating mb-3" id="select">
        <select name="sexo" class="form-select reg-campos" id="floatingSelect" placeholder="SEXO">
