  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      ...
      <li class="nav-item dropdown">
        ...
        <li class="nav-item dropdown">
          <a href="#" id="btnMensajes" class="nav-link" role="button" data-bs-toggle="dropdown">
...
<div class="container">
                              ...
                              @foreach ($sesiones as $sesion)
                               ...
                               <div class="col-md-4 mb-3"> 
                                        <div class="card card-body">
                                            ...
                                            <p class="card-text"><img src="{{$sesion->tutores->foto}}" class="card-img-top rounded-circle" alt="Tutor Photo">Tutor: {{$sesion->tutores->nombre}}</p>
    ...
    <script type='text/javascript'>
                        ...
                        btnMensajes.addEventListener('click', openMessagePanel);
    </script>
